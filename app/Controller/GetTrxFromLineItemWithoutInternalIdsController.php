...
class GetTrxFromLineItemWithoutInternalIdsController extends AppController
{
 ...
 */
    ...
    public function get_record()
    {
        ...
        $response = $this->Netsuite->restletv1($scripts['get_trx_from_line_item_without_internalid'], $data);
